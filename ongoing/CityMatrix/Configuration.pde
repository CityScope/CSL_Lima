...
public class Configuration {
  ...
  private void load(String path) {    
    ...
    PATTERNS = new Patterns(calibrationParameters);
    MESH = new Mesh(calibrationParameters, PATTERNS.getPBlocks());
    CITY = new City3D(MESH, calibrationParameters);
   ...
   */
  public void flip(PGraphics canvas, Capture cam) {
    canvas.pushMatrix();
    canvas.scale(-1, 1);
   ...
   */
  public void runSketches(String[] patterns, String[] city) {
    PApplet.runSketch(patterns, PATTERNS);
    PApplet.runSketch(city, CITY);
  }
  ...
  public void saveConfiguration() { 
    ...
    JSONArray buildings = CITY.saveConfiguration();
    calibrationParameters.setJSONArray("Buildings", buildings);
    
    JSONArray colorLimits = PATTERNS.saveColors();
